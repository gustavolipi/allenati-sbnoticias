																	...
																	<a href="#" target="_blank"
																	   style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
																		<font
																			...
																			size="3" color="#596167">
																			<img
																				src="<?php echo base_url() ?>assets/global/img/email/logo.png"
																				width="115"  alt="DiarioSBO"
																				border="0"
												...
												<td align="right">
													<div style="line-height: 27px;">
														<font face="Arial, Helvetica, sans-serif" size="3"
															  color="#0c4d78" style="font-size: 14px;">
															<strong
																style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #0c4d78;">
																Nome
															</strong></font>
													</div>
												</td>
