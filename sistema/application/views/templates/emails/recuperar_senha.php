            ...
            <td align="center" bgcolor="#eff3f8">
                                                                    ...
                                                                    <a href="#" target="_blank"
                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 13px;">
                                                                        <font
                                                                            ...
                                                                            size="3" color="#596167">
                                                                            <img
                                                                                src="<?php echo base_url() ?>assets/global/img/email/logo.gif"
				...
				Item -->
                                                                                    ...
                                                                                    <a href="#" target="_blank"
                                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                                        <font
                                                                                            ...
                                                                                            size="2" color="#596167">
                                                                                            <img
                                                                                                src="<?php echo base_url() ?>assets/global/img/email/facebook.gif"
                                                                                                width="10" height="19"
                                                                                                alt="Facebook"
                                                                                                border="0"
                                                                                                style="display: block;"/></font></a>
                                                                                    ...
                                                                                    <a href="#" target="_blank"
                                                                                       style="color: #596167; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                                                                        <font
                                                                                            ...
                                                                                            size="2" color="#596167">
                                                                                            <img
                                                                                                src="<?php echo base_url() ?>assets/global/img/email/twitter.gif"
                                                                                                width="19" height="16"
					...
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 17px; color: #4db3a4;">
						Olá <?php echo $nome_usuario ?>, sua nova senha de acesso ao <?php echo titulo_header ?> esta abaixo!
					</span></font>
                                        </div>
                                        <!-- padding -->
                                                ...
                                                <td align="center">
                                                    <div style="line-height: 27px;">
                                                        <font face="Arial, Helvetica, sans-serif" size="3"
                                                              color="#f54c57" style="font-size: 27px;">
                                                            <strong
                                                                style="font-family: Arial, Helvetica, sans-serif; font-size: 27px; color: #f54c57;">
                                                                <?php echo $senha ?>
                                                            </strong></font>
                                                    </div>
                                                </td>
                    ...
                    <tr>
		              ...
		              <a href="#" target="_blank" style="color: #5b9bd1; text-decoration: none;">DÚVIDAS FREQUENTES</a>
		              &nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url() ?>assets/global/img/email/dot.gif" alt="|"
                                                   width="6" height="9" class="mob_display_none"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
		              <a href="#" target="_blank" style="color: #5b9bd1; text-decoration: none;">TERMOS DE USO</a>
		              &nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo base_url() ?>assets/global/img/email/dot.gif" alt="|"
