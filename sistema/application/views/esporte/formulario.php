                        ...
                        <form class="form-horizontal form-row-seperated" method="post" enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="categoria" placeholder="Categoria" value="<?= @$registro->CATEGORIA ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group" style="display: none">
                                    <label class="control-label col-md-3">Tipo</label>
                                    <div class="col-md-9">
                                        <input type="text" name="tipo" placeholder="Tipo" value="<?= (@$registro->TIPO ? @$registro->TIPO : 'esportes') ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
