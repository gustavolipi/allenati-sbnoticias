                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group pull-right">
                                        <a href="<?php echo base_url('artigo/formulario') ?>" class="btn green">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable " id="sample_1">
                            ...
                            if (@$registros) {
                                ...
                                foreach (@$registros as $item => $value) {
                                    ...
                                    <tr class="odd gradeX">
                                        <td>
                                            <?php echo date('d/m/Y', strtotime($value->DATA)) ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="<?php echo base_url('artigo/formulario/' . $value->ID) ?>">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    <li style="display: none">
                                                        <a href="<?php echo base_url('artigo/fotos/' . $value->ID) ?>">
                                                            Fotos
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:executar('<?php echo base_url('artigo/acao/' . $value->ID . '/excluir') ?>');">
                                                            Excluir
                                                        </a>
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="dataTables_paginate paging_bootstrap_extended"
                                        ...
                                        <div class="pagination-panel">
                                            ...
                                            if ($atual_paginas > 1) {
                                                ...
                                                ?>
                                                <a href="<?php echo base_url() . 'artigo/index/' . $pagina ?>"
                                            ...
                                            <input type="number"
                                                   ...
                                                   minlength="1"
                                                   onchange="window.location='<?php echo base_url('artigo/index/') ?>/' + this.value"
