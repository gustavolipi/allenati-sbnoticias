                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group pull-right">
                                        <a href="<?= base_url('classificado/formulario') ?>" class="btn green">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable " id="sample_1">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <?= DataFormatar(@$value->DATAINICIO, 'd/m/Y') ?>
                                    </td>
                                    <td>
                                        <?= DataFormatar(@$value->DATAFIM, 'd/m/Y') ?>
                                    </td>
                                    <td>
                                        <div class="btn-group pull-right">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li>
                                                    <a href="<?= base_url('classificado/formulario/' . $value->ID) ?>">
                                                        Editar
                                                    </a>
                                                </li>
                                                <li>
                                                    <a
                                                        href="javascript:executar('<?= base_url('classificado/acao/' . $value->ID . '/excluir') ?>');">
                                                        Excluir
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="col-md-12">
                                    <div class="dataTables_paginate paging_bootstrap_extended" id="sample_2_paginate">
                                        <div class="pagination-panel">
                                            ...
                                            ?>
                                            <a href="<?= base_url() . 'classificado/index/' . $pagina ?>"
                                            ...
                                            <input type="number"
                                                ...
                                                minlength="1"
                                                onchange="window.location='<?= base_url('classificado/index/') ?>/' + this.value"
