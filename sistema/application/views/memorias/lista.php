                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="btn-group pull-right">
                                        <a href="<?php echo base_url('memorias/formulario') ?>" class="btn green">
                                        ...
                                        <td>
                                            <div class="btn-group pull-right">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="<?php echo base_url('memorias/formulario/' . $value->ID) ?>">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:executar('<?php echo base_url('memorias/acao/' . $value->ID . '/excluir') ?>');">
                                                            Excluir
                                                        </a>
                                                    </li>
                                                </ul>
                                    ...
                                    <div class="dataTables_paginate paging_bootstrap_extended"
                                        ...
                                        <div class="pagination-panel">
                                            ...
                                            if ($atual_paginas > 1) {
                                                ...
                                                ?>
                                                <a href="<?php echo base_url() . 'memorias/index/' . $pagina ?>"
                                            ...
                                            <input type="number"
                                                   ...
                                                   minlength="1"
                                                   onchange="window.location='<?php echo base_url('memorias/index/') ?>/' + this.value"
