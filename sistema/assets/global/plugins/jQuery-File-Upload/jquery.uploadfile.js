...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "",
            abortStr: "Retirar arquivo da fila",
            cancelStr: "Cancelar o envio",
            deletelStr: "Deletar arquivo",
            doneStr: "Enviado com sucesso",
        ...
        (function checkAjaxFormLoaded() {
            if ($.fn.ajaxForm) {
                ...
                if (s.dragDrop) {
                    var dragDrop = $('<div class="ajax-upload-dragdrop btn btn-primary" style="vertical-align:top;"></div>');
                    $(obj).before(dragDrop);
