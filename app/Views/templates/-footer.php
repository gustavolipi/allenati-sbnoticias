            ...
            <div class="row gy-4 gy-lg-0 justify-content-xl-between">
                ...
                <div class="col-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="widget">
                        ...
                        <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="mailto:contato@sbnoticias.com.br">contato@sbnoticias.com.br</a>
                        </p>
                    </div>
                </div>
                <div class="col-12 col-md-4 col-lg-3 col-xl-2">
                ...
                <div class="col-12 col-lg-3 col-xl-4">
                    <div class="widget">
                        ...
                        <p class="mb-1">
                            <a class="link-secondary text-decoration-none" href="mailto:radiobrasil@radiobrasilsbo.com.br">radiobrasil@radiobrasilsbo.com.br</a>
                        </p>
                ...
                <div class="col-xs-12 col-md-5 order-0 order-md-1">
                    <div class="nav justify-content-center justify-content-md-end">
                        <small class="credits text-secondary text-center text-md-start mt-2 fs-7">
                            Desenvolvido por <a href="https://allenati.com.br/" class="link-secondary text-decoration-none">Allenati</a>
                        </small>
                    </div>
                </div>
            </div>
